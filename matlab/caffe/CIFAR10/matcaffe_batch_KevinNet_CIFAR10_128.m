function [KevinCIFAR128_scores ,KevinCIFAR128_list_im] = matcaffe_batch_KevinNet_CIFAR10_128(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_KevinNet_CIFAR10_128(use_gpu);
else
  matcaffe_init_KevinNet_CIFAR10_128();
end
...
toc(initic);
KevinCIFAR128_list_im = y_ft_list_im;
KevinCIFAR128_scores = y_ft_scores;
if exist('filename', 'var')
    save([filename '_KevinCIFAR128.probs.mat'],'KevinCIFAR128_list_im','KevinCIFAR128_scores','-v7.3');
end
