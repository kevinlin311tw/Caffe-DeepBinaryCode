function [AlexNetCIFAR4096_scores ,AlexNetCIFAR4096_list_im] = matcaffe_batch_AlexNet_CIFAR10_4096(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_AlexNet_CIFAR10_4096(use_gpu);
else
  matcaffe_init_AlexNet_CIFAR10_4096();
end
...
toc(initic);
AlexNetCIFAR4096_list_im = y_ft_list_im;
AlexNetCIFAR4096_scores = y_ft_scores;
if exist('filename', 'var')
    save([filename '_AlexNetCIFAR4096.probs.mat'],'AlexNetCIFAR4096_list_im','AlexNetCIFAR4096_scores','-v7.3');
end
