function [KevinCIFAR64_scores ,KevinCIFAR64_list_im] = matcaffe_batch_KevinNet_CIFAR10_64(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_KevinNet_CIFAR10_64(use_gpu);
else
...
toc(initic);
KevinCIFAR64_list_im = y_ft_list_im;
KevinCIFAR64_scores = y_ft_scores;
