...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = '/home/iis/deep/rcnn_packages/caffe-new/examples/mycifar10/KevinNet/KevinNet_CIFAR10_48_deploy.prototxt';
end
if nargin < 3 || isempty(model_file)
  model_file = '/home/iis/deep/rcnn_packages/caffe-new/examples/mycifar10/KevinNet/KevinNet_CIFAR10_48_iter_50000.caffemodel';
end
