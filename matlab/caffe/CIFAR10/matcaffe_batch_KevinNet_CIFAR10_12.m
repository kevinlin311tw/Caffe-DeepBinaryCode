function [KevinCIFAR12_scores ,KevinCIFAR12_list_im] = matcaffe_batch_KevinNet_CIFAR10_12(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_KevinNet_CIFAR10_12(use_gpu);
else
  matcaffe_init_KevinNet_CIFAR10_12();
end
...
toc(initic);
KevinCIFAR12_list_im = y_ft_list_im;
KevinCIFAR12_scores = y_ft_scores;
if exist('filename', 'var')
    save([filename '_KevinCIFAR12.probs.mat'],'KevinCIFAR12_list_im','KevinCIFAR12_scores','-v7.3');
end
