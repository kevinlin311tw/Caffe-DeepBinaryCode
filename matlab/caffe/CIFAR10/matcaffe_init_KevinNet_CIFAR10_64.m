function  matcaffe_init_KevinNet_CIFAR10_64(use_gpu, model_def_file, model_file)
...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = '/home/iis/deep/rcnn_packages/Caffe-DeepBinaryCodes/examples/mycifar10/KevinNet_v2/CIFAR10-64/KevinNet_CIFAR10_64_deploy.prototxt';
end
if nargin < 3 || isempty(model_file)
  model_file = '/home/iis/deep/rcnn_packages/Caffe-DeepBinaryCodes-models/KevinNet_CIFAR10_64_iter_50000.caffemodel';
end
