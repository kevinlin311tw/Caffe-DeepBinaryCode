function [KevinCIFAR32_scores ,KevinCIFAR32_list_im] = matcaffe_batch_KevinNet_CIFAR10_32(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_KevinNet_CIFAR10_32(use_gpu);
else
  matcaffe_init_KevinNet_CIFAR10_32();
end
...
toc(initic);
KevinCIFAR32_list_im = y_ft_list_im;
KevinCIFAR32_scores = y_ft_scores;
if exist('filename', 'var')
    save([filename '_KevinCIFAR32.probs.mat'],'KevinCIFAR32_list_im','KevinCIFAR32_scores','-v7.3');
end
