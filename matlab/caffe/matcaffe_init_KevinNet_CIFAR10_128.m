function  matcaffe_init_KevinNet_CIFAR10_128(use_gpu, model_def_file, model_file)
...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = '/home/iis/deep/rcnn_packages/caffe-new/examples/mycifar10/KevinNet/KevinNet_CIFAR10_128_deploy.prototxt';
end
