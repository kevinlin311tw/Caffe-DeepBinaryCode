...
LayerParameter_LayerType UpgradeV0LayerType(const string& type) {
  ...
  } else if (type == "K1_euclidean_loss") {
    return LayerParameter_LayerType_K1_EUCLIDEAN_LOSS;
  } else if (type == "K2_euclidean_loss") {
    return LayerParameter_LayerType_K2_EUCLIDEAN_LOSS;
