...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_K1_EUCLIDEAN_LOSS:
    return new K1_EuclideanLossLayer<Dtype>(param);
  case LayerParameter_LayerType_K2_EUCLIDEAN_LOSS:
    return new K2_EuclideanLossLayer<Dtype>(param);
